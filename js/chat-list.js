...
function _renderChatItemContent(el,c){
  ...
  if(isSavedMsgs(c)){
    ...
    ciAvatarHtml=`<div class="av-img av-system"><svg viewBox="0 0 24 24" fill="none" width="20" height="20" aria-hidden="true"><path d="M12 2.5l6 2.4v5.5c0 4.2-2.5 8-6 9.6-3.5-1.6-6-5.4-6-9.6V4.9l6-2.4z" fill="rgba(255,255,255,.96)"/><path d="M12 5.1l3.3 1.3v4c0 2.7-1.4 5.2-3.3 6.5-1.9-1.3-3.3-3.8-3.3-6.5v-4L12 5.1z" fill="rgba(139,92,246,.24)"/></svg></div>`;
...
function updateHeaderUI(c, name) {
  ...
  if(hn) {
    ...
    if(isVerified(c) && !isSavedMsgs(c) && !isSystemChat(c)) {
  ...
  if(hdrAv) {
    if(isSavedMsgs(c)){
      ...
      hdrAv.className='av-img av-system';
      hdrAv.innerHTML='<svg viewBox="0 0 24 24" fill="none" width="20" height="20" aria-hidden="true"><path d="M12 2.5l6 2.4v5.5c0 4.2-2.5 8-6 9.6-3.5-1.6-6-5.4-6-9.6V4.9l6-2.4z" fill="rgba(255,255,255,.96)"/><path d="M12 5.1l3.3 1.3v4c0 2.7-1.4 5.2-3.3 6.5-1.9-1.3-3.3-3.8-3.3-6.5v-4L12 5.1z" fill="rgba(139,92,246,.24)"/></svg>';
    } else {
